      ...
      >
        {products.map((product) => (
          <Link 
            ...
            className="min-w-[300px] md:min-w-[400px] snap-start group block"
          >
            <motion.div
              whileHover={{ y: -10 }}
              className="w-full"
            >
              ...
              <div className="flex justify-between items-start">
                ...
                <span className="font-serif text-lg tracking-wider text-premium-charcoal/60 lowercase">View Details</span>
              </div>
            </motion.div>
          </Link>
        ))}
